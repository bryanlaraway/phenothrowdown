/* OMIM_101600  */
insheet using "/Volumes/Time Machine/PycharmProjects/phenothrowdown/out/scatterplot_data/OMIM_101600.csv"

gen recall_max_ic_score = max_ic_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace max_ic_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
...
gen recall_iccs_score = iccs_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace iccs_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")


gen recall_sim_ic_score = sim_ic_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace sim_ic_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")


gen recall_sim_j_score = sim_j_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace sim_j_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_phenolog_max_score = phenolog_max_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace phenolog_max_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_phenolog_additive_score = phenolog_additive_score if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace phenolog_additive_score = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
...
gen recall_max_ic_rank = max_ic_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace max_ic_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_iccs_rank = iccs_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace iccs_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_sim_ic_rank = sim_ic_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace sim_ic_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_sim_j_rank = sim_j_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace sim_j_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_phenolog_max_rank = phenolog_max_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace phenolog_max_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")

gen recall_phenolog_additive_rank = phenolog_additive_rank if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
replace phenolog_additive_rank = . if inlist(gene_candidate_id , "MGI:95522", "ZFIN:ZDB-GENE-980526-255", "ZFIN:ZDB-GENE-980526-488", "ZFIN:ZDB-GENE-060503-14", "MGI:95523", "ZFIN:ZDB-GENE-030323-1")
